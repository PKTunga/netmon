    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('password_updated', models.DateTimeField(blank=True, null=True, verbose_name='password updated')),
                ...
                ('language', models.CharField(blank=True, choices=[('en', 'English')], max_length=8, null=True, verbose_name='language')),
            ...
            options={'verbose_name': 'user', 'verbose_name_plural': 'users', 'abstract': False, 'swappable': 'AUTH_USER_MODEL'},
